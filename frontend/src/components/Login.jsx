...
const Login = () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        if (result.user.role === 'student') {
          navigate('/', { replace: true })  // Students go to home page
        } else {
          navigate('/dashboard', { replace: true })  // Other roles go to dashboard
        }
      } else {
  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-white">
      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden items-center justify-start p-8 pl-20 pr-2">
        ...
        <div className="relative z-10 w-full max-w-3xl">
          {/* Logo */}
          <Link to="/" className="flex items-center mb-8 mt-8 sm:mt-12 lg:mt-16 justify-center lg:justify-start hover:opacity-80 transition-opacity duration-200">
          ...
          <div className="mb-8 ml-auto mr-0 lg:mr-8 max-w-xl text-center lg:text-left">
            <p className="text-lg sm:text-xl lg:text-2xl text-gray-700 leading-relaxed">
              Order from your <span className="text-red-600 font-semibold">favorite cafeterias</span> & get it <span className="text-red-600 font-semibold">delivered fast!</span>
            </p>
          </div>
        ...
        <div className="bg-white rounded-3xl shadow-2xl relative w-full max-w-md">
          ...
          <div className="text-center mb-4 sm:mb-8">
            ...
            <p className="text-gray-600 text-xs sm:text-base">
              Login to your <span className="text-red-600 font-semibold">UniBite</span> account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-5">
            ...
            <div className="flex items-center justify-between pt-1 sm:pt-2">
              <div className="flex items-center">
                ...
                />
                <label htmlFor="remember-me" className="ml-2 sm:ml-3 block text-xs sm:text-sm text-gray-600 select-none">
                  Remember Me
                </label>
              </div>
              <Link to="/forgot-password" className="text-xs sm:text-sm text-red-500 hover:text-red-600 font-medium transition-colors duration-200">
                Forgot?
              </Link>
            </div>
          ...
          <div className="mt-4 sm:mt-8 text-center">
            <p className="text-xs sm:text-base text-gray-600">
              ...
              <Link to="/register" className="text-red-500 hover:text-red-600 font-bold transition-colors duration-200">
                Register Now
              </Link>
            </p>
            ...
            {/* Debug: Test Connection Button - Hidden on Mobile */}
            <button
              type="button"
              onClick={testConnection}
              className="hidden sm:block mt-4 text-xs text-gray-500 hover:text-gray-700 underline mx-auto"
            >
